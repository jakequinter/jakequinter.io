...
const About = () => (
  ...
  >
    ...
    <Box margin="0 auto" width={{ xs: '90%', sm: '70%', md: '50%' }}>
      <Box w="100%" mt="8">
        ...
        <SimpleGrid columns={{ sm: 1, md: 1, lg: 2 }} spacing={5}>
          <Box color="#484848">
            ...
            <Text pt="2">
              ...
              business and engineering school until I finally found something
              that I loved. For me, that was (you guessed it) computers!
            </Text>
          </Box>
          <Box
      ...
      <Box w="100%" mt="12" color="#484848">
        ...
        <SimpleGrid columns={{ xs: 2, sm: 2, md: 2, lg: 3 }} spacing={5}>
          <Box>
            <List py="3" spacing={3}>
              <ListItem>
                <ListIcon icon="chevron-right" color="black.500" />
                JavaScript <Box style={{ display: 'inline' }} as={DiJsBadge} />
              </ListItem>
              <ListItem>
                <ListIcon icon="chevron-right" color="black.500" />
                React <Box style={{ display: 'inline' }} as={DiReact} />
              </ListItem>
              <ListItem>
                <ListIcon icon="chevron-right" color="black.500" />
                Next.js <Box style={{ display: 'inline' }} as={SiNextDotJs} />
              </ListItem>
            </List>
          </Box>
          <Box ml="auto" mr="auto">
            <List py="3" spacing={3}>
              <ListItem>
                <ListIcon icon="chevron-right" color="black.500" />
                Node.js <Box style={{ display: 'inline' }} as={FaNodeJs} />
              </ListItem>
              <ListItem>
                <ListIcon icon="chevron-right" color="black.500" />
                HTML & CSS{' '}
                <Box style={{ display: 'inline' }} as={AiOutlineHtml5} />
              </ListItem>
              <ListItem>
                <ListIcon icon="chevron-right" color="black.500" />
                Design <Box style={{ display: 'inline' }} as={FaAdobe} />
              </ListItem>
            </List>
          </Box>
          <Box ml="auto">
            <List py="3" spacing={3}>
              <ListItem>
                <ListIcon icon="chevron-right" color="black.500" />
                Java <Box style={{ display: 'inline' }} as={DiJava} />
              </ListItem>
              <ListItem>
                <ListIcon icon="chevron-right" color="black.500" />
                Databases <Box style={{ display: 'inline' }} as={FiDatabase} />
              </ListItem>
              <ListItem>
                <ListIcon icon="chevron-right" color="black.500" />
                Servers{' '}
                <Box style={{ display: 'inline' }} as={AiOutlineCloudServer} />
              </ListItem>
            </List>
          </Box>
        </SimpleGrid>
      ...
      <Box w="100%" mt="12" color="#484848">
        ...
        <Text>
          ...
          world. I created this site to familiarize myself with Next.js, SSG and
          SSR, along with Vercel’s fast refresh, file base routing system and
          easy no config deploys.
        </Text>
        <Heading
          as="h5"
          size="sm"
